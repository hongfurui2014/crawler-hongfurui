...
public class HttpClientTest {
    ...
    public void doGetTestWayOne() {
        ...
        try {
            ...
            params.append("name=" + URLEncoder.encode("洪福锐", "utf-8"));
            params.append("&");
    ...
    public void doGetTestWayTwo() {
        ...
        try {
            ...
            params.add(new BasicNameValuePair("name", "洪福锐"));
    ...
    public void doPostTestTwo() {
        ...
        // 创建Post请求
        HttpPost httpPost = new HttpPost("http://localhost:8080/doPostControllerObject");
        User user = new User();
        user.setName("潘晓婷");
        user.setAge(18);
        user.setGender("女");
